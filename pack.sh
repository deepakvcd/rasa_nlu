...
cd ..
python -m rasa_nlu.server -c config_spacy.json --server_model_dirs="clinical" --port=5000 &
python -m rasa_nlu.server -c config_spacy.json --server_model_dirs="normal" --port=5001